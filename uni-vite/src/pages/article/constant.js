export const ARTICLE_LIST = [
  {
    ...
    content: [
      ...
      },
      {
        type: 'richText',
        richTexts: [
          '你画画时的样子就像一个小小的魔法师——眼睛亮晶晶的，小手稳稳的，能把白纸变成五彩斑斓的奇妙世界。<b>你的耐心比彩虹还要美丽，你的想象力比星星还要闪亮。</b>',
          '你知道吗？当别的孩子已经画完时，你还在认真地为小花朵添上露珠，为小恐龙画上微笑的翅膀，这种专注是最珍贵的魔法。你笔下的太阳会唱歌，云朵长着翅膀，大海里游着彩虹鱼……这些都不是随便谁都能想出来的，这是独属于你的闪闪发光的创造力。'
        ]
      },
      {
        type: 'image',
        images: 'https://yizhao-1259410276.cos.ap-shanghai.myqcloud.com/images/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20251216003935_117_2.jpg',
        description: '小雪人'
      },
      {
        type: 'image',
        images: 'https://yizhao-1259410276.cos.ap-shanghai.myqcloud.com/images/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20251216003937_119_2.jpg'
      },
      {
        type: 'image',
        images: [
      ...
      },
      {
        ...
        richText: [
          ...
          '<b>世界正是需要像你这样，既愿意耐心倾听，又敢于大胆创造的小小艺术家。</b> 你的每一幅画，都是送给这个世界的一份独特礼物！'
        ]
      },
    ]
  }
